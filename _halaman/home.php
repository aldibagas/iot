...
<head>
    <meta charset="utf-8">
    <title>Informasi Otomasi Teknologi</title>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <h4>Value</h4>
                            <p class="mb-0">SPEED work to build strong NETWORKING through remarkable ACHIEVEMENTS</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="<?=assets()?>img/about.png" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5 mb-5">
            <div class="bg-white">
                <div class="owl-carousel vendor-carousel">
                    ...
                    <img src="<?=img()?>vendor8.png" alt="">
                    <img src="<?=img()?>vendor9.png" alt="">
                    <img src="<?=img()?>vendor10.png" alt="">
                    <img src="<?=img()?>vendor11.png" alt="">
                    <img src="<?=img()?>vendor12.png" alt="">
                    <img src="<?=img()?>vendor13.png" alt="">
                    <img src="<?=img()?>vendor14.png" alt="">
                    <img src="<?=img()?>vendor15.png" alt="">
                    <img src="<?=img()?>vendor16.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">INFORMASI OTOMASI TEKNOLOGI</a>. All Rights Reserved.
